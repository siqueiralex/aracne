...
aracne: HTML_Parser.o Proxy_Server.o Spider.o String_Functions.o HTTP_Response.o HTTP_Request.o src/main.cpp
	g++  -Wall -std=c++11 -o aracne Spider.o HTML_Parser.o HTTP_Request.o HTTP_Response.o Proxy_Server.o String_Functions.o src/main.cpp

bypass: HTML_Parser.o Proxy_Server.o  String_Functions.o HTTP_Response.o HTTP_Request.o src/main.cpp
	g++  -pthread -Wall -std=c++11 -o bypass HTML_Parser.o HTTP_Request.o HTTP_Response.o Proxy_Server.o String_Functions.o src/bypass.cpp
